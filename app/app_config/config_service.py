...
class ConfService:
    ...
    common_name = {
        "eu.europa.ec.eudi.age_verification_mdoc": "Age Verification ",
    }
    ...
    error_list = {
        "-1": "Error undefined. Please contact Age Verification Provider backend support.",
        "0": "No error.",
        ...
        "304": "Age Verification attribute(s) missing.",
    ...
    # ------------------------------------------------------------------------------------------------
    # First image option in age verification form. Format: base64 JPEG
    ...
    # Second image option in age verification form. Format: base64 JPEG
